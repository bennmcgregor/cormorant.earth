...
![[non-zero-waste-pattern.jpg|eager]]
_A typical pattern—note the scraps around the curves_

![[pants-cutting-pattern.png]]
_A zero waste pants pattern_

I learned a lot about zero-waste patterns from these resources:  
[Birgitta Helmersson's book on Zero-Waste Patterns](https://www.birgittahelmersson.com/pages/book)  
[Liz Haywood's blog](https://lizhaywood.com.au/zero-waste-resources/)  
[Isaboko (the original inspiration for me)](https://isaboko.com/)
...
[Many, many, many traditional forms of dress from around the world](https://fr.scribd.com/document/896257010/OceanofPDF-com-Cut-My-Cote-Dorothy-Burnham) use zero-waste pattern cutting techniques, because it was historically [so much work to create fabric](https://www.youtube.com/playlist?list=PLzbQbOIfEmsck4ypQsUFNVeZr3RXjnx0T). Kimonos are one example of this: https://isaboko.com/pages/guidebook-vol-1 (scroll down a bit to see the zero-waste pattern). 
